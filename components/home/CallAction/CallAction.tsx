...
const CallAction = () => {
  return (
    <div className="container" id="contact">
      <div className="mil-half-container mil-stl mil-up">
        <div className="mil-text-box mil-g-m4 mil-p-160-160">
          <p className="mil-stylized mil-m2 mil-mb60 mil-up">Contact</p>
          <h2 className="mil-display3 mil-mb60 mil-m1 mil-up">
            Let’s <span className="mil-a1">make </span> <br />
            an <span className="mil-a1">impact </span>
            <br />
            together.
          </h2>
          <p className="mil-text-md mil-deco-text mil-shortened mil-up">
